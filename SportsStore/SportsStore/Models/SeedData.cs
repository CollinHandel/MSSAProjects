        ...
        public static void EnsurePopulated(IApplicationBuilder app)
        {
            ...
            if (!context.Products.Any())
            {
                context.Products.AddRange(
                    ...
                    new Product
                    {
                        Name = "Soccer Ball", Description = "FIFA-approved side and weight", Category = "Soccer", Price = 79500
                    },
                    new Product
                    {
                        Name = "Corner Flags", Description = "Give your playing field a professional touch", Category = "Soccer", Price = 34.95M
                    },
                    new Product { 
